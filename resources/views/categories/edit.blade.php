    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        ...
        <div class="max-w-2xl mx-auto">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Edit Kategori</h1>
                <p class="mt-2 text-sm text-gray-500">Perbarui informasi kategori produk ini.</p>
            </div>

            <div class="bg-white shadow-xl rounded-3xl border border-gray-100 overflow-hidden">
                <form action="{{ route('categories.update', $category->id) }}" method="POST" class="p-6 md:p-8">
                    @csrf
                    @method('PUT')
