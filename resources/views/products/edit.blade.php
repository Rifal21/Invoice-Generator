        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white shadow-xl rounded-3xl border border-gray-100 overflow-hidden">
                <form action="{{ route('products.update', array_merge(['product' => $product->id], request()->query())) }}"
                    method="POST" enctype="multipart/form-data" class="p-6 md:p-10">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="flex flex-col sm:flex-row gap-6 items-start">
                                ...
                                <div
                                    ...
                                    @if ($product->image)
                                        ...
                                        <div id="placeholder-icon" class="text-gray-400 flex flex-col items-center hidden">
                                        @else
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label for="category_id" class="block text-sm font-bold text-gray-900 mb-2">Kategori</label>
                                <div class="relative">
