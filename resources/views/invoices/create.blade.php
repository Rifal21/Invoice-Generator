    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                <h2 class="text-3xl font-bold leading-7 text-gray-900 sm:truncate sm:tracking-tight">Create New Invoice</h2>
                <p class="mt-1 text-sm text-gray-500">Fill in the details below to generate a new invoice.</p>
            </div>
        </div>
            ...
            row.innerHTML = `
                ...
                <td class="px-3 py-4">
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="number" class="total-input block w-full rounded-md border-0 py-1.5 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-gray-50 font-medium" readonly>
                    </div>
                </td>
