        ...
        async function scanInvoice(input) {
            ...
            try {
                ...
                try {
                    ...
                    Toast.fire({
                        icon: 'error',
                        title: 'Gagal memproses respon server. Silakan cek konsol browser.'
                    });
                    return;
                }
                ...
                if (result.success) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: 'Invoice berhasil di-scan!'
                    });
                } else {
                    Toast.fire({
                        icon: 'error',
                        title: result.message || 'Gagal men-scan invoice.'
                    });
                }
            } catch (error) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: 'Terjadi kesalahan saat men-scan invoice.'
                });
            } finally {
                btn.disabled = false;
