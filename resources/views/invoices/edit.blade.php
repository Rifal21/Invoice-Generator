            ...
            row.innerHTML = `
                ...
                <td class="px-3 py-4">
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="number" class="price-input block w-full rounded-md border-0 py-1.5 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-gray-50" readonly value="${price}">
                    </div>
                </td>
                <td class="px-3 py-4">
                ...
                <td class="px-3 py-4">
                    <input type="text" class="unit-input block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-center bg-gray-50" readonly value="${unit}">
                </td>
                <td class="px-3 py-4">
                    <div class="relative rounded-md shadow-sm">
                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
