...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/backup/push-sync', [\App\Http\Controllers\BackupController::class, 'pushSync'])->name('backup.push-sync');
    Route::post('/backup/pull-sync', [\App\Http\Controllers\BackupController::class, 'pullSync'])->name('backup.pull-sync');
    ...
    Route::get('examination-reports/{examination_report}/stream', [\App\Http\Controllers\ExaminationReportController::class, 'stream'])->name('examination-reports.stream');
    Route::resource('examination-reports', \App\Http\Controllers\ExaminationReportController::class);
